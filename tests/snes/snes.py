...
class SNES:
    def __init__(self):
        self.tests = [
            ...
            ContentTest(
                "components/gates/4030_4069_linked.nts",
            ...
            ## 4514
            ContentTest(
                "components/advanced/4514_decoder.nts",
                "components/advanced/4514_decoder.input",
                "components/advanced/4514_decoder.output"
            ),
